...
args = {
    "project_id": "bash-test2-0205070901",
}

dag = DAG(
    "bash-test2-0205070901",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="""
Created with Elyra 3.15.0 pipeline editor using `bash-test.pipeline`.
    """,
...
op_c86b1529_42c6_48e0_905e_49bef0f89226 = BashOperator(
    ...
    xcom_push=False,
    env={"TEST_ENV": "Hello World dayeon2"},
